...
const FrameworkModal: React.FC<FrameworkModalProps> = ({ show, onHide, currentFramework, onSelect }) => {
    const [selectedId, setSelectedId] = useState<string>(currentFramework || 'CO-STAR');
