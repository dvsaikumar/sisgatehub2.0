...
const ToneCard: React.FC<ToneCardProps> = ({ tone, isSelected, onClick }) => {
...
const ToneModal: React.FC<ToneModalProps> = ({ show, onHide, currentTone, onSelect }) => {
    const [selectedId, setSelectedId] = useState<string>(currentTone || 'Formal');
