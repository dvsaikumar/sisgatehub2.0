                                ...
                                <Form className="w-100">
                                    <Row>
                                        <Col xxl={5} xl={7} lg={10} className="mx-auto">
                                            <h4 className="text-center mb-4">Sign Up to Sisgate Hub</h4>
                                            ...
                                            <Row className="gx-3">
                                                ...
                                                <Col lg={12} as={Form.Group} className="mb-3">
                                                    ...
                                                    <Form.Control placeholder="Enter your email id" type="text" value={email} onChange={e => setEmail(e.target.value)} />
                                                </Col>
                                                <Col lg={12} as={Form.Group} className="mb-3">
                                                    <Form.Label>Password</Form.Label>
                                                    <InputGroup className="password-check">
                                                        <span className="input-affix-wrapper affix-wth-text">
                                                            <Form.Control placeholder="6+ characters" value={password} onChange={e => setPassword(e.target.value)} type={showPassword ? "text" : "password"} />
                                            ...
                                            <Button variant='primary' className="btn-rounded btn-uppercase btn-block" onClick={handleSignup} >Create account</Button>
