...
const ChatPopup = () => {
    ...
    return (
        <React.Fragment>
            <div className={classNames("hk-chat-popup", { "d-flex": showChatPopup })} style={{ bottom: '400px' }} >
            ...
            <Button variant="primary" size="lg" className="btn-icon btn-floating btn-rounded btn-popup-open" onClick={handleChatPopup} autoFocus style={{ bottom: '100px' }} >
                <span className="icon">
                    <span className="feather-icon"><MessageCircle /></span>
                </span>
            </Button>
            <div className={classNames("chat-popover shadow-xl", { "d-flex": showPopup })} style={{ bottom: '140px' }}><p>Try Sisgate Hub for free and connect with your customers now!</p></div>
