                    ...
                    <div className="quick-access-form-wrap">
                        <Form className="quick-access-form border">
                            <Row className="gx-3">
                                ...
                                <Col xxl={2}>
                                    <Form.Group className="mb-3">
                                        <Button variant="primary" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" className="btn-gradient-primary btn-animated btn-block">
                                            <Plus weight="bold" className="me-2" color="#fff" />Create New
                                        </Button>
                                    </Form.Group>
                                    <Form.Group className="mb-3">
