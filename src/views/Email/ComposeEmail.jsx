        ...
        <div className={classNames("compose-email-popup", { "d-block": composeEmail }, { "minimize-email-popup": minimize }, { "maximize-email-popup": maximize })}  >
            <div className="d-flex flex-column h-100">
                ...
                <Form>
                    ...
                    <Form.Group className="mb-3" >
                        <AIFormControl placeholder="Subject" fieldName="Email Subject" />
                    </Form.Group>
                    <Form.Group>
                        <AIFormControl as="textarea" rows={10} placeholder="Type your message here..." fieldName="Email Body" noInputGroup={true} />
                    </Form.Group>
                </Form>
