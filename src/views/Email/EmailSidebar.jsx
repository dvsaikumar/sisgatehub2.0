            ...
            <Nav className="emailapp-sidebar">
                <SimpleBar className="nicescroll-bar">
                    <div className="menu-content-wrap">
                        <Button className="btn-gradient-primary btn-animated btn-block mb-4 show-compose-popup" onClick={() => Compose(!composeEmail)} >
                            <PlusPhos weight="bold" className="me-2" color="#fff" />Compose email
                        </Button>
