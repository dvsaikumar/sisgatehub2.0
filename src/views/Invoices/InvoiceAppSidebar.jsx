        ...
        <nav className="invoiceapp-sidebar">
            <SimpleBar className="nicescroll-bar">
                <div className="menu-content-wrap">
                    <Dropdown>
                        <Dropdown.Toggle className="btn-gradient-primary btn-animated btn-block mb-4">
                            <Plus weight="bold" className="me-2" color="#fff" />Create
                        </Dropdown.Toggle>
                        <Dropdown.Menu>
                            <Dropdown.Item as={Link} to="create-invoice" >Create Invoice</Dropdown.Item>
