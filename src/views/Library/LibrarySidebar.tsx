...
import {
    Book, FileText, Star, Trash, CaretRight, Folder, Briefcase, Pulse,
...
const LibrarySidebar: React.FC<LibrarySidebarProps> = ({ filter, setFilter, onCategorySelect }) => {
    ...
    const fetchCategories = async () => {
        try {
            ...
            const nested = parentCats.map((parent: any) => ({
                ...parent,
    ...
    const getRelevantIcon = (item: Category) => {
