                                        ...
                                        <Row className="gx-3">
                                            <Col sm={6}>
                                                <Form.Group className="mb-3" >
                                                    ...
                                                    <AIFormControl type="text" defaultValue="Kate" fieldName="First Name" />
                                                </Form.Group>
                                            </Col>
                                            <Col sm={6}>
                                                <Form.Group className="mb-3" >
                                                    <Form.Label>Last Name</Form.Label>
                                                    <AIFormControl type="text" defaultValue="Jones" fieldName="Last Name" />
                                                </Form.Group>
                                            </Col>
                                        </Row>
                                        <Row className="gx-3">
                                            <Col sm={12}>
                                                <Form.Group className="mb-3">
                                                    ...
                                                    <AIFormControl type="text" defaultValue="Lane no 1, Newyork" fieldName="Location" />
                                                </Form.Group>
                                            </Col>
                                        </Row>
                                        <Row className="gx-3">
                                            <Col sm={12}>
                                                <Form.Group className="mb-3">
                                                    ...
                                                    <AIFormControl as="textarea" rows={10} placeholder="Write an internal note" fieldName="Bio" noInputGroup={true} />
                                                    <Form.Text muted>
                                        ...
                                        <Row className="gx-3">
                                            <Col sm={12}>
                                                <Form.Group className="mb-3">
                                                    ...
                                                    <AIFormControl type="text" defaultValue="hencework.com" fieldName="Personal Website" />
                                                </Form.Group>
                                            </Col>
                                            <Col sm={12}>
                                                <Form.Group className="mb-3">
                                                    <Form.Label>Phone</Form.Label>
                                                    <AIFormControl type="tel" defaultValue="xxxxxxx987" fieldName="Phone Number" />
                                                </Form.Group>
                                                <Form.Check
                                                    type='checkbox'
                                                    id="customCheckList4"
                                        ...
                                        <Row className="gx-3">
                                            <Col sm={12}>
                                                <Form.Group className="mb-3">
                                                    ...
                                                    <AIFormControl type="text" defaultValue="Kate" fieldName="Username" />
                                                </Form.Group>
                                            </Col>
                                        </Row>
                                        <Row className="gx-3">
                                            <Col sm={12}>
                                                <Form.Group className="mb-3">
                                                    ...
                                                    <AIFormControl type="text" defaultValue="Lane no 1, Newyork" fieldName="Email" />
                                                </Form.Group>
                                            </Col>
                                        </Row>
                                        <Row className="gx-3">
                                            <Col sm={12}>
                                                <Form.Group className="mb-3">
                                                    ...
                                                    <AIFormControl type="text" defaultValue="hencework.com" fieldName="URL" />
                                                </Form.Group>
                                            </Col>
                                        </Row>
                                        ...
                                        <Row className="gx-3">
                                            <Col sm={12}>
                                                <Form.Group className="mb-3">
                                                    ...
                                                    <AIFormControl type="text" defaultValue="UA-1387652-1" fieldName="Tracking Code" />
                                                    <Form.Text muted>
