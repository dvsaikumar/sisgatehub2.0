                ...
                <div>
                    <div className="taskbar-toolbar">
                        <div className="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                            <Button className="flex-shrink-0 btn-gradient-primary btn-animated me-4" onClick={() => setAddNewBoard(!addNewBoard)} >
                                <PlusPhos weight="bold" className="me-2" color="#fff" />Create New
                            </Button>
                            <Form.Check
                                type="switch"
                                id="custom-switch"
